...
export default function Dashboard() {
    ...
    const bool = location?.state?.created;
    ...
    if ((runArr.length && !isLoaded) || (!runArr.length && !isLoaded)){
        setIsLoaded(true)
    }
    ...
    return (
        <>
            ...
            <hr id="line"></hr>
            <div id='notifDiv'>
                {(showNotif && runArr.length) ? (
                    <div id='notif'>Route Created!</div>
                ) : null}
            </div>
            <div id="table_div">
                {runArr.length ?
                    ...
                    :
                    <>
                        <div id="noRoutes">NO ROUTES! <br /> START CREATING!</div>
                    </>
                }
            </div>
        </>
